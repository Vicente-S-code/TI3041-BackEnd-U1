...
Terminal POS (Nueva Venta): http://127.0.0.1:8000/ventas/nueva/

Inventario con Badges: http://127.0.0.1:8000/productos/

Registro de Clientes (con Switch): http://127.0.0.1:8000/clientes/nuevo/

Panel Administrativo Django: http://127.0.0.1:8000/admin/ (Usuario: admin | Contraseña: admin123)